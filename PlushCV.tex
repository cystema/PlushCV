...
% 
% TODO:
% 1. Fix bullet icon and alignment
% 2. Remove Hacky fix for awkward extra vertical space
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% CHANGELOG:
% 1. Added command for references.
% 2. Split the header to two column format, added relevant icons to contact info.
% 3. Used paracol to fix multiple-page flow.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%Icons: fontawesome5 package
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\header
  ...
  {first.last@mail.com}
  {+1 (999)999-9999}
  {\href{https://www.github.com/sansquoi}{sansquoi}}
  {\href{https://www.linkedin.com/}{li-username}}{Toronto, ON}
